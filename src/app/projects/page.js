            ...
            <div className="w-full max-w-[600px] space-y-6 text-left">
              {projects.map((project, index) => (
                <motion.div
                  ...
                  className="border-b border-light-darker/20 pb-6"
                >
                  ...
                  {project.caseStudy && (
                    <button
                      ...
                      className="inline-flex items-center text-primary font-medium hover:text-primary-light transition-colors mb-4"
                    >
